...
export function useReimbursementFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useReimbursementFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.reimbursement.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useReimbursementCount<T extends Prisma.reimbursementCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.reimbursementCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useReimbursementCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.reimbursement.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useReimbursementFindManyWithCount<
  T extends Prisma.reimbursementFindManyArgs,
  R extends { data: GetFindResult<Prisma.$reimbursementPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.reimbursementFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useReimbursementFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.reimbursement.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useReimbursementFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useReimbursementFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.reimbursement.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
