...
export function EmployeeListPage(props: EmployeeListPageProps) {
  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: ['user', 'organization', 'reimbursement.count', 'sick_leave.count', 'vacation.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('organization', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('reimbursement', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'reimbursement',
          header: 'Reimbursement',
          accessorKey: 'reimbursement',
          cell: ({ row: { original: record } }: any) => record?._count?.reimbursement,
        }
      : null,
