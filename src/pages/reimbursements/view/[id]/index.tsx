...
import { useReimbursementFindFirst, useRoqClient } from 'lib/roq';

import { ReimbursementInterface } from 'interfaces/reimbursement';

function ReimbursementViewPage() {
  ...
  const { data, error, isLoading } = useReimbursementFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('reimbursement', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/reimbursements/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem
                  label="Request Date"
                  text={data?.request_date ? format(data?.request_date, 'dd-MM-yyyy') : ''}
                />
